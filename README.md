...
- Auto/H.264 NVENC/AMF/QSV/VideoToolbox/software H.264/VP9 profiles, bitrate,
...
- переключаемый RU/EN интерфейс в Advanced с применением без перезапуска и локализованным меню трея;
...
- RU/EN интерфейс и тёмная/светлая тема с акцентом `#ED760E`.
- первый запуск с безопасным Auto-профилем и явным отказом от автозапуска захвата;
